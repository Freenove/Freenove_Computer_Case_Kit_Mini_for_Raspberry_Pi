...
:red:`Fail to do so may result in the Freenove Computer Case Kit Mini for Raspberry Pi being unusable or causing damage to components.`
...
**Important note** for users of the **FNK0108R/Q/V/W** models: due to hardware limitations of the Dual-NVMe and Quad-NVMe Adapter Boards, please **do not** enable **PCIe 3.0** mode, as this may cause the Raspberry Pi to fail to boot.
...
Change the parameter of **Terminal** from ture to **false**, save and clost the file. 
