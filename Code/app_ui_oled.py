...
class OledTab(QWidget):
    def __init__(self, width=700, height=400):
        ...
        self.screen_display_time_minus_btn = None  # Display time minus button
        self.screen_display_time_plus_btn = None   # Display time plus button
    ...
    def init_ui(self):
        ...
        # Container 1 - Checkboxes for 3 screens (now left-aligned)
        ...
        # Container 2 - Display time labels for 3 screens - left aligned
        ...
        # Container 3 - Time adjustment buttons (Minus and Plus)
        ...
        self.screen_display_time_minus_btn = PressableButton("Minus")
        self.screen_display_time_minus_btn.setFocusPolicy(Qt.NoFocus)  # Disable focus for button
        self.container3_layout.addWidget(self.screen_display_time_minus_btn)

        self.screen_display_time_plus_btn = PressableButton("Plus")
        self.screen_display_time_plus_btn.setFocusPolicy(Qt.NoFocus)  # Disable focus for button
        self.container3_layout.addWidget(self.screen_display_time_plus_btn)

        self.container3.setLayout(self.container3_layout)
        self.main_layout.addWidget(self.container3)

        # Container 4 - Screen 1 combo boxes (date and time format)
        ...
        self.container4_layout.addWidget(self.screen1_data_format_combo)
        ...
        self.container4_layout.addWidget(self.screen1_time_format_combo)

        self.container4.setLayout(self.container4_layout)
        self.main_layout.addWidget(self.container4)

        # Container 5 - Screen 2 and Screen 3 combo boxes
        ...
        self.container5_layout.addWidget(self.screen2_interchange_combo)

        # Screen 3 combo box - changed options to Temp, Duty
        ...
        self.container5_layout.addWidget(self.screen3_interchange_combo)

        self.container5.setLayout(self.container5_layout)
        self.main_layout.addWidget(self.container5)

        # Container 6 - Task control buttons (Start Task and Stop Task)
        self.container6 = QFrame()
        self.container6.setStyleSheet("background-color: #333333; border: 1px solid #555555; border-radius: 5px;")
        self.container6_layout = QHBoxLayout()
        self.container6_layout.setContentsMargins(5, 5, 5, 5)
        self.container6_layout.setSpacing(5)

        # Task control buttons
        self.start_task_button = PressableButton("Start Task")
        self.start_task_button.setFocusPolicy(Qt.NoFocus)  # Disable focus for button
        self.container6_layout.addWidget(self.start_task_button)

        self.stop_task_button = PressableButton("Stop Task")
        self.stop_task_button.setFocusPolicy(Qt.NoFocus)  # Disable focus for button
        self.container6_layout.addWidget(self.stop_task_button)
    ...
    def adjust_size_dimensions(self):
        ...
        container_height = (content_height - 50) // 6  # 40px for spacing between containers, 6 containers (10px spacing * 5)
        ...
        self.container6.setFixedHeight(container_height)
        ...
        # Row 1 - All checkboxes (only 3 now)
        self.container1.setFixedWidth(container_width)
        self.container1.setFixedHeight(container_height)
        # Distribute space evenly among the 3 checkboxes
        checkbox_width = (inner_width - 10) // 3  # Subtract spacing between checkboxes
        ...
        # Row 2 - Display time labels (only 3 now)
        self.container2.setFixedWidth(container_width)
        self.container2.setFixedHeight(container_height)
        # Distribute space evenly among the 3 labels
        label_width = (inner_width - 10) // 3  # Subtract spacing between labels
        ...
        # Row 3 - Time adjustment buttons (Minus and Plus)
        self.container3.setFixedWidth(container_width)
        self.container3.setFixedHeight(container_height)
        # Divide space between the two buttons
        minus_plus_spacing = 5
        btn_width = (inner_width-minus_plus_spacing) // 2
        self.screen_display_time_minus_btn.setFixedWidth(btn_width)
        self.screen_display_time_minus_btn.setFixedHeight(inner_height)
        self.screen_display_time_plus_btn.setFixedWidth(btn_width)
        self.screen_display_time_plus_btn.setFixedHeight(inner_height)

        # Row 4 - Screen 1 combo boxes (date and time format)
        ...
        # Row 5 - Screen 2 and Screen 3 combo boxes
        self.container5.setFixedWidth(container_width)
        self.container5.setFixedHeight(container_height)
        # Split width between the two combo boxes
        combo5_spacing = 5  # 5px spacing between combo boxes
        available_combo5_width = inner_width - combo5_spacing  # Subtract spacing between combo boxes
        combo5_1_width = available_combo5_width // 2
        combo5_2_width = available_combo5_width - combo5_1_width
        self.screen2_interchange_combo.setFixedWidth(combo5_1_width)
        self.screen2_interchange_combo.setFixedHeight(inner_height)
        self.screen3_interchange_combo.setFixedWidth(combo5_2_width)
        self.screen3_interchange_combo.setFixedHeight(inner_height)

        # Row 6 - Task control buttons (Start Task and Stop Task)
        self.container6.setFixedWidth(container_width)
        self.container6.setFixedHeight(container_height)
        # Divide space between the two buttons
        btn6_spacing = 5
        btn6_width = (inner_width-btn6_spacing) // 2
        self.start_task_button.setFixedWidth(btn6_width)
        self.start_task_button.setFixedHeight(inner_height)
        self.stop_task_button.setFixedWidth(btn6_width)
        self.stop_task_button.setFixedHeight(inner_height)
